...
exports.addTourToCart = exports.bookTour = void 0;
...
var stripe = Stripe('pk_test_51JVbgIFA4p9Ui9SpquCsCf1r8vOQ5sTq3isjE4e3OHsAEHBKTaMFytUNNLld0MSVxMWgyc88NHJrIsFAPUOZUtWO00YI2QQVmf');
...
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _axios.default)("/api/v1/tours/".concat(tourId.tourId));

          case 3:
            req = _context2.sent;
            tour = JSON.parse(req.request.response).data.data;
            _context2.next = 7;
            return _axios.default.patch("/api/v1/users/updateMyCart", {
              name: "".concat(tour.name),
              description: "".concat(tour.description),
              images: ["".concat(tour.imageCover)],
              amount: "".concat(tour.price) * 100,
              currency: 'usd',
              quantity: 1
            });
  ...
  return function addTourToCart(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.addTourToCart = addTourToCart;
...
var addToCartBtn = document.getElementById('book-tour-cart'); // DELEGATION
...
if (addToCartBtn) addToCartBtn.addEventListener('click', function (e) {
  ...
  var tour = e.target.dataset;
  (0, _stripe.addTourToCart)(tour);
});
